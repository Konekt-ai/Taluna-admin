...
--  Corre esto UNA VEZ en Supabase -> SQL Editor -> New query, DESPUÉS de
--  haber corrido admin-setup.sql.
--
--  El Organizador (/estudio.html) es un espacio APARTE del catálogo real:
--  el cliente lo llena desde el celular para organizar bolsas, straps,
--  cinturones, combinaciones y subir fotos. Todo se guarda en la nube:
